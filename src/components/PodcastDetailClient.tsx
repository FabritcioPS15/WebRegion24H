  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-0">
        ...
        <section
          ref={heroRef}
          className="bg-accent py-20 border-b-8 border-brand"
        >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-6">
                    {youtubeId ? (
                      ...
                      >
                        ...
                        {isPlaying ? 'Reproduciendo...' : (selectedPodcast.live ? 'Ver en Vivo' : 'Reproducir Episodio')}
                      </button>
                    ) : (
                      <a
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                  className={`relative ${
                    (selectedPodcast.live || youtubeId) ? 'aspect-video max-w-2xl' : 'aspect-square max-w-lg'
                  } mx-auto lg:mx-0 shadow-2xl border-4 border-white/5 overflow-hidden rounded-lg bg-black group/hero-media cursor-pointer`}
                  onClick={() =>
                    !isPlaying && youtubeId && setIsPlaying(true)
                  }
                >
                  {youtubeId && isPlaying ? (
                    <iframe
                    ...
                    <>
                      <img
                        ...
                        className="w-full h-full object-cover grayscale opacity-80 group-hover/hero-media:opacity-100 transition duration-700"
                      />
        ...
        <section className="max-w-7xl mx-auto px-6 py-20">
          <div className="flex items-center gap-4 mb-12">
            <h2 className="text-sm font-black text-accent uppercase tracking-[0.4em] border-l-4 border-brand pl-6 py-1">
